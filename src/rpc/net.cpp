        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "shieldedtx_rate_limited", "The number of shielded transaction responses rate-limited for this peer"},
                    {RPCResult::Type::NUM, "shieldeddata_rate_limited", "The number of shielded block-data responses rate-limited for this peer"},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    for (const CNodeStats& stats : vstats) {
        ...
        obj.pushKV("shieldedtx_rate_limited", statestats.m_shielded_tx_rate_limited);
        obj.pushKV("shieldeddata_rate_limited", statestats.m_shielded_data_rate_limited);
...
static RPCHelpMan addnode()
{
    return RPCHelpMan{"addnode",
                ...
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
                    HelpExampleCli("addnode", "\"192.168.0.6:19335\" \"onetry\" true")
            + HelpExampleRpc("addnode", "\"192.168.0.6:19335\", \"onetry\" true")
                },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCHelpMan addconnection()
{
    return RPCHelpMan{"addconnection",
        ...
        RPCExamples{
            HelpExampleCli("addconnection", "\"192.168.0.6:19335\" \"outbound-full-relay\" true")
            + HelpExampleRpc("addconnection", "\"192.168.0.6:19335\" \"outbound-full-relay\" true")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...
static RPCHelpMan disconnectnode()
{
    return RPCHelpMan{"disconnectnode",
                ...
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
                    HelpExampleCli("disconnectnode", "\"192.168.0.6:19335\"")
            + HelpExampleCli("disconnectnode", "\"\" 1")
            + HelpExampleRpc("disconnectnode", "\"192.168.0.6:19335\"")
                    ...
                    RPCResult::Type::ARR, "", "",
                    {
                        {RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::ARR, "addresses", "Only when connected = true",
                            {
                                {RPCResult::Type::OBJ, "", "",
                                {
                                    {RPCResult::Type::STR, "address", "The BTX node IP and port we're connected to"},
    ...
    return RPCHelpMan{"getnetworkinfo",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::NUM, "min_smile_v2_version", "minimum peer protocol version required for SMILE v2 shielded transactions"},
                        {RPCResult::Type::NUM, "smile_v2_enforcement_height", "chain height at which SMILE v2 version enforcement activates"},
...
static RPCHelpMan addpeeraddress()
{
    return RPCHelpMan{"addpeeraddress",
        ...
        RPCExamples{
            HelpExampleCli("addpeeraddress", "\"1.2.3.4\" 19335 true")
    + HelpExampleRpc("addpeeraddress", "\"1.2.3.4\", 19335, true")
        },
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
